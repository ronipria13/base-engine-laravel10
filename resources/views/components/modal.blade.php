<div x-cloak wire:key="{{ $value }}">
    ...
    <div x-cloak x-show="openModal"
        ...
        <div x-show="openModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
            ...
            <div class="absolute inset-0 bg-gray-500 opacity-75" x-cloak x-on:click="openModal = false"></div>
        </div>
        ...
        <div x-show="openModal" x-cloak x-transition:enter="ease-out duration-300"
            ...
            class="relative bg-gray-100 rounded-lg px-4 pt-5 pb-4 overflow-y-auto md:max-h-screen max-h-96 shadow-xl transform transition-all lg:max-w-screen-md sm:max-w-lg sm:w-full sm:p-6">
