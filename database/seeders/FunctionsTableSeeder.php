...
class FunctionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('functions')->insert(array (
            ...
            6 => 
            array (
                'id' => '14d61ed4-edbb-4c16-984b-63d5541de94d',
                'function_name' => 'datatable',
                'function_desc' => 'Fungsi dasar untuk menampilkan semua data yang terkait dalam controller dilengkapi dengan searching, pagination dan lainnya untuk melayani datatable',
                'type' => 'core',
                'created_by' => 'admin',
                'updated_by' => NULL,
